...
public class SplashFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        percentage.setFont(new java.awt.Font("Segoe UI Light", 0, 24)); // NOI18N
        percentage.setForeground(new java.awt.Color(255, 255, 255));
        percentage.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        percentage.setToolTipText("");
        jPanel1.add(percentage, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 440, 250, 40));

        progressBar.setForeground(new java.awt.Color(25, 165, 0));
        progressBar.setBorder(null);
        jPanel1.add(progressBar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 480, 800, 10));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nutrii/application/gui/images/splashResized.jpg"))); // NOI18N
